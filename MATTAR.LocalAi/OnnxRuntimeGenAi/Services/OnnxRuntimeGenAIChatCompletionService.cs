...
public sealed class OnnxRuntimeGenAIChatCompletionService : IChatCompletionService
{
        ...
        CancellationToken cancellationToken = default)
    {
        ...
        return [ new(role: AuthorRole.Assistant, content: result.ToString()) ];
    }
        ...
        [EnumeratorCancellation] CancellationToken cancellationToken)
    {
        ...
        onnxRuntimeGenAIPromptExecutionSettings.MaxLength = prompt.Length + 100;
    ...
    /// <param name="onnxRuntimeGenAIPromptExecutionSettings">Onnx runtime Generative Ai Execution settings</param>
    /// <returns></returns>
    ...
    /// <summary>
    /// Apply Prompt Execution Settings
    /// </summary>
    /// <param name="generatorParams"></param>
    /// <param name="onnxRuntimeGenAIPromptExecutionSettings">Onnx runtime Generative Ai Execution settings</param>
    private static void ApplyPromptExecutionSettings(
